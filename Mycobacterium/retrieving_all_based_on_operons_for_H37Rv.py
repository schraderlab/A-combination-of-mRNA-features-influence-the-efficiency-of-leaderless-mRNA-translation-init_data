...
#-------------------------make sure sorted in order first by genes start and then by operons--------------------
from itertools import repeat

F = open("operon_list_H37Rv.txt")
f = F.readlines()
fields=[]
operons = []
operon_start_sites = []
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
# all = sorted(all, key=lambda gene: gene[7])
# all = sorted(all, key=lambda operon: operon[0])
...
F4= open("H37Rv_fasta_without_header.txt")
...
#     print(all[i][38])
# print(all[3614][11])
# print(type(all[3614][11]))
# print(all[3614][19])
# print(type(all[3614][11]))
# if int(all[3614][11]) == int(all[3614][19]):
#     print("TRUE")
# else:
#     print("FALSE")
# print(all[8][11])
...
for i in range(1, len(all), 1):
    if all[i][16] == "processed" and all[i][2] == "+" and all[i][15] == "Y":
        ...
        all[i][31] = len(f4[int(all[i][11])-1:int(all[i][12])].upper()) #indexes need to be changed based on how many true and distances
        all[i][32] = f4[int(all[i][11])-1:int(all[i][11])+2].upper()
        all[i][33] = f4[int(all[i][11])-1:int(all[i][11])+49].upper()
        all[i][34] = 1
        ...
        all[i][31] = len(f4[int(all[i][11])-2:int(all[i][12])].upper()) #indexes need to be changed based on how many true and distances
        all[i][32] = f4[int(all[i][11])-1:int(all[i][11])+2].upper()
        all[i][33] = f4[int(all[i][11])-2:int(all[i][11])+48].upper()
        all[i][34] = 2
        ...
        all[i][31] = len(Seq(f4[int(all[i][12])-1:int(all[i][11])]).reverse_complement().upper())
        all[i][32] = Seq(f4[int(all[i][11])-3:int(all[i][11])]).reverse_complement().upper()
        all[i][33] = Seq(f4[int(all[i][11])-50:int(all[i][11])]).reverse_complement().upper()
        all[i][34] = 1
        ...
        all[i][31] = len(Seq(f4[int(all[i][12])-1:int(all[i][11])+1]).reverse_complement().upper())
        all[i][32] = Seq(f4[int(all[i][11])-3:int(all[i][11])]).reverse_complement().upper()
        all[i][33] = Seq(f4[int(all[i][11])-49:int(all[i][11])+1]).reverse_complement().upper()
        all[i][34] = 2
